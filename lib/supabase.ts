...
const supabaseUrl = process.env.NEXT_PUBLIC_SUPABASE_URL || 'https://fojbhsbxmpcstwioxbtg.supabase.co'
const supabaseAnonKey = process.env.NEXT_PUBLIC_SUPABASE_ANON_KEY || 'sb_publishable_rQ1db4bkYEz0P2hKAmnQog_qCBIsx7I'
